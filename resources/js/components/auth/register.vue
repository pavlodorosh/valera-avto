                ...
                <div class="login-form">
                  ...
                  <form>
                    <div class="form-group">
                      <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Прізвище, Ім`я">
                    </div>
                    <div class="form-group">
                  ...
                  <hr>
                  <div class="text-center">
                    <router-link class="font-weight-bold small" to="/user">Вже є профіль?</router-link>
                  </div>
                  <div class="text-center">
                  </div>
                </div>
